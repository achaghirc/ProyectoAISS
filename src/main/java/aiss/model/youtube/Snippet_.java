...
@JsonPropertyOrder({ "authorDisplayName", "authorProfileImageUrl", "authorChannelUrl", "authorChannelId", "channelId",
		"videoId", "textDisplay", "textOriginal", "canRate", "viewerRating", "likeCount", "moderationStatus",
